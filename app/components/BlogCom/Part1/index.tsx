  ...
  return (
    ...
    <div className={styles.back}>
        ...
        <div className={styles.part2}>
            <p className={styles.title}>Wealth Free Life <span>Blog</span></p>
            <p className={styles.text}>Here, we strive to provide you with insightful and informative content that will help you learn something new and, most importantly, useful.</p>
        </div>
    </div>
    </div>
  )
