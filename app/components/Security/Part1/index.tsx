...
export default function Part1() {
  return (
    <div className={styles.back}>
        ...
        <Image src="/gold-shield.webp" width={1500} height={1500} alt="lock" className={styles.white_lock}/>
        <Image src="/back-shield-gold.webp" width={500} height={500} alt="lock" className={styles.back_shield_gold}/>
